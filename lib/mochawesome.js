...
function Mochawesome (runner, options) {
  ...
  runner.on('fail', function(test) {
    ...
    saveScreenshotToFile(config.reportScreenshotDir + '/' + test.fullTitle().replace(/[^\w_\-]/g, '_').toLowerCase() + '.png', function(){});
  });
...
function cleanTest (test) {
  ...
  if (err && err.stack) {
    err.scr = '<img src="./screenshots/' + test.fullTitle().replace(/[^\w_\-]/g, '_').toLowerCase() + '.png">';
